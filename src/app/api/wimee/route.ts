...
━━━━━━━━━━━━━━━━━━━━━━━━━
ชื่อเต็ม: International Program for Sangha (IPS#11) — (โครงการบวชเรียนนานาชาติ ปีการศึกษา 2570)
สังกัด: DCI — Dhamma Chakra International

กลุ่มเป้าหมาย:
- นักเรียนจบ ม.6 (อายุ 18 ปีขึ้นไป)
- นักศึกษาจบ ปวส. ปี 3
- คนที่กำลังจะก้าวสู่ช่วงหัวเลี้ยวหัวต่อของชีวิต
- รวมไปถึงนักเรียนระดับมัธยมศึกษาตอนต้น - ตอนปลาย (ม.ต้น - ม.ปลาย) ของ โรงเรียนเตรียมพุทธศาสตร์ เขาแก้วเสด็จ ปราจีนบุรี (มุ่งเน้นสามเณรและนักเรียนเตรียมบวชเรียน)

โครงการ AI ตั้งรับ & สนับสนุน (DCI AI Support):
- สามารถเชิญครู ผู้อำนวยการโรงเรียนต่างๆ ทั่วประเทศ เข้าร่วมอบรมการใช้งาน AI ได้ เพื่อแสดงถึงความพร้อมในการจัดการเรียนการสอนและเทคโนโลยีการศึกษา
- หากนำนักเรียน/สามเณรมาร่วมอบรมด้วย จะใช้เวลาในการเรียนรู้ 3 วัน โดยวันแรกเป็นการเตรียมความพร้อมและปรับพื้นฐาน ส่วนวันที่ 2-3 เป็นการอบรมการใช้งานและสร้างสรรค์ด้วย AI อย่างเข้มข้น
...
- สถานที่: ศูนย์การศึกษาเขาแก้วเสด็จ จ.ปราจีนบุรี (สิ่งแวดล้อมดี บรรยากาศเอื้อการเรียนรู้)
