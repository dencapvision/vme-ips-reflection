...
const SUGGESTIONS = [
  { icon: "🏫", text: "แนะนำโครงการ IPS ให้กับทางโรงเรียนเตรียมพุทธศาสตร์" },
  { icon: "🙏", text: "การเชิญชวนเด็กเห็นความสำคัญในการบวชเรียน" },
  { icon: "👨‍👩‍👦", text: "การชวนให้พ่อแม่เห็นประโยชน์ที่ลูกชายบวชเรียน" },
  { icon: "📚", text: "โอกาสทางการเรียนภาษาอังกฤษมีอะไรบ้างสำหรับจูงใจครู ผู้ปกครอง และนักเรียน" },
  { icon: "📋", text: "การนัดหมายเพื่อขอเข้าพบนำเสนอโครงการฯมีขั้นตอนอย่างไร" },
  { icon: "✨", text: "คำพูดพลังบวกวันนี้" },
];
